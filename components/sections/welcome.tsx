  ...
  return (
    ...
    >
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 md:px-8">
        <div className="relative overflow-hidden rounded-3xl sm:rounded-[2rem] border border-[#1D2A73]/70 bg-[#1D2A73]/95 backdrop-blur-2xl shadow-[0_16px_60px_rgba(29,42,115,0.35)] px-5 sm:px-8 md:px-10 py-8 sm:py-10 md:py-12">
          ...
          <div className="pointer-events-none absolute inset-0">
            ...
            <div
              ...
              style={{
                backgroundColor: "rgba(29, 42, 115, 0.95)",
              }}
            />
            {/* Subtle radial highlights */}
            <div className="absolute -top-24 left-1/2 -translate-x-1/2 w-80 h-80 bg-[radial-gradient(circle_at_center,rgba(29,42,115,0.35),transparent_60%)] opacity-80" />
            <div className="absolute bottom-[-6rem] right-[-2rem] w-64 h-64 bg-[radial-gradient(circle_at_center,rgba(29,42,115,0.25),transparent_60%)] opacity-85" />
            {/* Inner border glow */}
            <div className="absolute inset-[1px] rounded-[inherit] border border-[#1D2A73]/30" />
          </div>
          ...
          <div className="space-y-1.5 sm:space-y-2.5">
            ...
            <div className="flex items-center justify-center gap-2 pt-1">
              <span className="h-px w-10 sm:w-16 md:w-20 bg-[#FFD83F]/40" />
              <span className="w-1.5 h-1.5 rounded-full bg-[#FFD83F] shadow-[0_0_14px_rgba(255,216,63,0.8)]" />
              <span className="h-px w-10 sm:w-16 md:w-20 bg-[#FFD83F]/40" />
            </div>
          </div>
