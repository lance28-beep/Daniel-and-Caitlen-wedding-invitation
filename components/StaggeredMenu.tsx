  ...
  return (
    ...
    >
      ...
      >
        ...
        >
            {(() => {
            const raw = colors && colors.length ? colors.slice(0, 4) : ['#0C1230', '#1D2A73', '#163693'];
            let arr = [...raw];
            if (arr.length >= 3) {
        ...
        <aside
          ...
          ref={panelRef}
          className="staggered-menu-panel absolute top-0 right-0 h-full bg-[#1D2A73] flex flex-col p-[6em_2em_2em_2em] overflow-y-auto z-10"
          ...
          <div className="sm-panel-inner flex-1 flex flex-col gap-6">
            ...
            {displaySocials && socialItems && socialItems.length > 0 && (
              <div className="sm-socials mt-auto pt-8 flex flex-col gap-3" aria-label="Social links">
                <h3 className="sm-socials-title m-0 text-base font-medium [color:var(--sm-accent,#FFD83F)]">Socials</h3>
                <ul
...
.sm-scope .staggered-menu-panel { position: absolute; top: 0; right: 0; width: clamp(260px, 38vw, 420px); height: 100%; background: #1D2A73; backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); display: flex; flex-direction: column; padding: 6.5em 2.25em 2.25em 2.25em; overflow-y: auto; z-index: 10; }
...
.sm-scope .sm-socials-title { margin: 0; font-size: 1.05rem; font-weight: 500; color: var(--sm-accent, #FFD83F); }
...
.sm-scope .sm-socials-link:focus-visible { outline: 2px solid var(--sm-accent, #FFD83F); outline-offset: 3px; }
...
.sm-scope .sm-socials-link:hover { color: var(--sm-accent, #FFD83F); }
...
.sm-scope .sm-panel-item:hover { color: var(--sm-accent, #FFD83F); }
.sm-scope .sm-panel-list[data-numbering] { counter-reset: smItem; }
.sm-scope .sm-panel-list[data-numbering] .sm-panel-item::after { counter-increment: smItem; content: counter(smItem, decimal-leading-zero); position: absolute; top: 0.1em; right: 3.2em; font-size: 18px; font-weight: 400; color: var(--sm-accent, #FFD83F); letter-spacing: 0; pointer-events: none; user-select: none; opacity: var(--sm-num-opacity, 0); }
